...
class OrderControllerTest {
    ...
    void rejectsInvalidPaginationAndHandlesErrors() throws Exception {
        ...
        assertThat(controller.notFound(new OrderNotFoundException("missing")).getStatusCode().value()).isEqualTo(404);
        assertThat(controller.badRequest(new IllegalArgumentException("bad")).getStatusCode().value()).isEqualTo(400);
